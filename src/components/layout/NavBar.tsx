  ...
  return (
    <nav className="w-full flex flex-col md:flex-row items-center md:justify-between gap-0 px-6 pt-6 md:pt-16 pb-4 bg-transparent">
      ...
      <div className="flex flex-row items-center gap-10 md:gap-6 mt-4 md:mt-0">
        ...
        <Button
          variant="outline"
          className="text-base sm:text-lg md:text-xl lg:text-[24px] bg-white text-green-800 font-semibold px-4 py-2 sm:px-6 sm:py-3 rounded-lg transition duration-[1200ms] ease-in-out shadow-[6px_6px_10px_rgba(0,0,0,0.5)] hover:scale-105 hover:bg-white hover:text-green-800"
        >
          Fale Conosco
        </Button>
      </div>
